...
var langConfig = {"id":0,"numDel":"<span class=\"num_delim\"> <\/span>","numDelS":" ","numDec":",","prepTags":["{prep_with}","{prep_With}","{prep_about}","{prep_About}","{prep_into}","{prep_Into}"],"prep":[["{prep_with},{prep_With}","С*,З*,Льв*","со,Со"],["{prep_with},{prep_With}","*,Са*,Се*,Сё*,Си*,Со*,Су*,Сэ*,Сю*,Ся*,За*,Зе*,Зё*,Зи*,Зо*,Зу*,Зэ*,Зю*,Зя*","с,С"],["{prep_about},{prep_About}","А*,О*,У*,И*,Э*","об,Об"],["{prep_about},{prep_About}","*","о,О"],["{prep_into},{prep_Into}","В*,Ф*,Льв*","во,Во"],["{prep_into},{prep_Into}","*,Ва*,Ве*,Вё*,Ви*,Во*,Ву*,Вэ*,Вю*,Вя*,Фа*,Фе*,Фё*,Фи*,Фо*,Фу*,Фэ*,Фю*,Фя*","в,В"]],"parent":0,"timeSys":["24hour"],"yearOffset":0,"flexLast":false,"revOrder":false,"RTL":false,"numRules":{"int":[[100,[11,12,13,14],3],[10,[1],1],[10,[2,3,4],2],["*",0,3]],"float":2},"sexRules":[[1,2],["*",1]],"larr":"&larr;","rarr":"&rarr;"}, larr = langConfig.larr, rarr = langConfig.rarr;
Month1="Январь";
Month10="Октябрь";
Month10_of="Октября";
Month11="Ноябрь";
...
audio_claimed_future_access_title="Доступ к аудиозаписи вскоре будет открыт";
...
audio_clear_current_playlist="ТЕСТ";
...
global_N_comments=["","%s комментарий","%s комментария","%s комментариев"];
global_N_people_liked=["","Понравилось %s человеку","Понравилось %s людям","Понравилось %s людям"];
global_N_people_shared=["","Поделился %s человек","Поделились %s человека","Поделились %s человек"];
...
global_money_amount_rub_short=["","%s руб.","%s руб.","%s руб."];
...
privacy_options_only_me="Just Athena";
